...
```
(Для получения первого докумнта можно скопировать содержание папки **example** - папки **img и includes**, а также файлы **main.adoc и title.adoc** - предваритьельно ознакомившись с содержимым)
